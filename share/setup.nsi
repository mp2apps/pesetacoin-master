...
Section -post SEC0001
    ...
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\PesetaCoin.lnk" $INSTDIR\pesetacoin-qt.exe
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\Uninstall PesetaCoin.lnk" $INSTDIR\uninstall.exe
