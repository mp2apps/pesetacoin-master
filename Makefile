...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Fri Apr 4 17:58:15 2014
# Project:  pesetacoin-qt.pro
# Template: app
# Command: /usr/bin/qmake USE_UPNP=- -o Makefile pesetacoin-qt.pro
#############################################################################
...
CC            = gcc
CXX           = g++
DEFINES       = -DQT_WEBKIT -DQT_GUI -DBOOST_THREAD_USE_LIB -DBOOST_SPIRIT_THREADSAFE -DUSE_IPV6=1 -DHAVE_BUILD_INFO -DLINUX -D_FILE_OFFSET_BITS=64 -DQT_NO_DEBUG -DQT_WEBKIT_LIB -DQT_GUI_LIB -DQT_NETWORK_LIB -DQT_CORE_LIB -DQT_SHARED
...
LIBS          = $(SUBLIBS)  -L/usr/lib/i386-linux-gnu /home/cryptomp/pesetacoin-master/src/leveldb/libleveldb.a /home/cryptomp/pesetacoin-master/src/leveldb/libmemenv.a -lrt -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lpthread -lQtWebKit -lQtGui -lQtNetwork -lQtCore 
AR            = ar cqs
RANLIB        = 
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
...
/home/cryptomp/pesetacoin-master/src/leveldb/libleveldb.a: FORCE
	cd /home/cryptomp/pesetacoin-master/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-pipe -fstack-protector-all -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a
